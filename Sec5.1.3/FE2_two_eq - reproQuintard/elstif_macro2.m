...
%     flux_mat = dFlux_mat * [gradU_mat; u_mat];
    ...
    dFlux_inc = [0.0 0 0; 0 0.0 0]; %
%     dFlux_inc = [-0.1064 0 0; 0 -0.1064 0]; 
...
%     dFlux_mat = [-0.45749 0 0 0; 0 -0.45749 0 0];
%     flux_mat = dFlux_mat * [gradU_mat; u_mat; u_inc];
%     
%     dSou_mat = [0 0 -0.249837  0.249837]; 
% %     dSou_mat = [0 0 0.0 0.0]; 
%     sour_mat = dSou_mat * [gradU_mat; u_mat; u_inc];
%     
%     dSou_inc = [0 0  0.249837 -0.249837]; 
% %     dSou_inc = [0 0  0.0 0.0]; 
%     sour_inc = dSou_inc * [gradU_mat; u_mat; u_inc];


%%  
    eps_mat = 0.62; eps_inc = 0.38;
%     eps_mat = 0.6693; eps_inc = 0.3307;
    r_inc = 0e7 * eps_inc;
%     r_inc = 2.976336948937916e+07;
