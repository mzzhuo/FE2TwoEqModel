...
% C_consA(1,3) = coefs.hc0 ; % this value may not be important.
% C_consB(1,4) = coefs.hc1 ; % this value may not be important.
...
F_cons_mat = K_consA' * u(nnode+nlamb+3+1:nnode+nlamb+4);
F_cons_inc = K_consB' * u(nnode+nlamb+3+2:nnode+nlamb+5);
...
% 
% F_cons = K_cons' * u(nnode+nlamb+3+1:nnode+nlamb+4);
%%
