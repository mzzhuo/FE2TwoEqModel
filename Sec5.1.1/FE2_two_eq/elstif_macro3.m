...
%
function [kel, rel] = elstif_macro3(ncoord,nelnodes,lmncoord,coefs,elu_mat,eldu_mat,elu_inc,eldu_inc)
%
%    
...
%     flux_mat = dFlux_mat * [gradU_mat; u_mat];
    ...
    [dFlux_mat,flux_mat,dFlux_inc,flux_inc,sour_mat,dSou_mat,sour_inc,dSou_inc]  = micro3(gradU_mat,gradU_inc,u_mat,u_inc);
...
% 
    ...
    kel_im = kel_im - N * (dSou_inc(3) * N') * w(intpt)*dt ... 
             - dNdx * dFlux_inc(:,1:3) * [dNdx'; N'] * w(intpt)*dt;
