...
% figure;
hold on;
plot(coords(:,1),u(1:nnode,7),'o','MarkerSize',4);
plot(coords(:,1),u(nnode+1:end,7),'s','MarkerSize',4);
...
%
fileID = fopen('eg3macroT_mat_144sfe2_new.txt','w');
...
%
fileID = fopen('eg3macroT_inc_144sfe2_new.txt','w');
fprintf(fileID,'%12.6f, %12.6f \n',macroT_inc');
fclose(fileID);

%%
hold on;
plot(macroT_mat(:,1),macroT_mat(:,2),'-')
plot(macroT_inc(:,1),macroT_inc(:,2),'-')